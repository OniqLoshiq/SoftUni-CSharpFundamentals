...
namespace Forum.App.Services
{
    public class PostService : IPostService
    {
        ...
        {
            Category category = forumData.Categories.FirstOrDefault(x => x.Name == postCategory);
        ...
        {
            IEnumerable<IReplyViewModel> replies = this.forumData.Replies.Where(p => p.PostId == postId)
