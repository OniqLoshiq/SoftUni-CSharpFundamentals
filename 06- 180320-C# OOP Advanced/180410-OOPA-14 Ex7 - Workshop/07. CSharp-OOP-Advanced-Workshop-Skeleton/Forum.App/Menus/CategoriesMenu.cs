namespace Forum.App.Menus
{
    ...
    public class CategoriesMenu : Menu, IPaginatedMenu
	{
		...
		protected override void InitializeButtons(Position consoleCenter)
		{
            ...
            {
                this.labelFactory.CreateButton(defaultButtonContent[0], defaultButtonPositions[0])
            };
        ...
        public override IMenu ExecuteCommand()
		{
            ...
            {
                cmd = this.commandFactory.CreateCommand("ViewCategoryMenu");
                idString = this.categories[actualIndex].Id.ToString();
            }
            else
            {
                cmd = this.commandFactory.CreateCommand(string.Join("", this.CurrentOption.Text.Split()));
            }

            return cmd.Execute(idString);
		}
