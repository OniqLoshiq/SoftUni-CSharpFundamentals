namespace Forum.App.Menus
{
	...
	public class ViewPostMenu : Menu, IIdHoldingMenu
	{
        ...
        public ViewPostMenu(ILabelFactory labelFactory, ISession session, IPostService postService, ICommandFactory commandFactory, IForumViewEngine viewEngine)
        {
		...
		{		
            ...
            {
                this.labelFactory.CreateLabel($"Replies: {repliesCount}", repliesStartPosition)
            };
		...
		public override IMenu ExecuteCommand()
		{
            ...
            IMenu view = cmd.Execute(this.postId.ToString());
