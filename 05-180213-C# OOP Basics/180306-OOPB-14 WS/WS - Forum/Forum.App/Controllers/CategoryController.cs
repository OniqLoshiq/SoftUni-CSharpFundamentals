namespace Forum.App.Controllers
{
    ...
    public class CategoryController : IController, IPaginationController
    {
        ...
        private IEnumerable<Post> AllCategoryPosts { get; set; }
        private int LastPage => this.AllCategoryPosts.Count() / 11;
        ...
        {
            this.AllCategoryPosts = PostService.GetPostsByCategory(this.CategoryId);

            this.PostTitles = this.AllCategoryPosts.Skip(this.CurrentPage * PAGE_OFFSET).Take(PAGE_OFFSET).Select(p => p.Title).ToArray();
        }
