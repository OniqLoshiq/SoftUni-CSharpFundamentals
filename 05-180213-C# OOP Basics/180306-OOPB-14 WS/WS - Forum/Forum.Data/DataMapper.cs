    ...
    class DataMapper
    {
        ...
        public static List<User> LoadUsers()
        {
            ...
            foreach (var line in dataLines)
            {
                ...
                if(args.Length == 4)
                {
                    postIds.AddRange(args[3].Split(',', StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToArray());
                }
        ...
        public static List<Post> LoadPosts()
        {
            ...
            foreach (var line in dataLines)
            {
                ...
                if(args.Length == 6)
                {
                    replies.AddRange(args[5].Split(',', StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToArray());
                }
        ...
        public static void SavePosts(List<Post> posts)
        {
            ...
            foreach (var post in posts)
            {
                ...
                string line = string.Format(postFormat, post.Id, post.Title, post.Content, post.CategoryId, post.AuthorId, string.Join(",", post.Replies));
                lines.Add(line);
            }
